...
Мы разрабатываем учебный проект - веб-обертку для помощи команде Tinkoff Cafe(другого учебного проекта) в тестировании их гипотез, в т.ч. проведении автоматической кросс-валидации и выведении результатов. 
